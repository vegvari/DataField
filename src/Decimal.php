...
class Decimal extends Number
{
    ...
    protected function __construct($precision = 10, $scale = 2, $default = null, $nullable = false, $unsigned = false)
    {
    ...
    public static function make($precision, $scale, $default = null)
    {
        $class = get_called_class();
        $instance = new $class($precision, $scale, $default, false);
        return $instance;
    }
